...
export default function AgendaPage() {
  ...
  const [partnerSlug, setPartnerSlug] = React.useState(initialPartner);
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div className="flex flex-wrap items-end gap-2">
              ...
              <select
                ...
                className="h-10 min-w-48 rounded-xl border border-stone-300 bg-white px-3 text-xs shadow-sm focus:outline-none focus:ring-2 focus:ring-stone-900 sm:h-9"
                value={partnerSlug}
                onChange={(e) => {
                  setPartnerSlug(e.target.value);
                  setPivotISO(todayISO());
                }}
              >
