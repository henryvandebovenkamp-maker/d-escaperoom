...
const schema = z.object({
  ...
  province: z.string(), // blijft string; casten we bij write
...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (typeof body.googleMapsUrl === "string") {
      const trimmed = body.googleMapsUrl.trim();
      body.googleMapsUrl = trimmed.length ? trimmed : undefined; // lege string → undefined
    }
