...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        {/* Gradient strip */}
        <div className="h-2 w-full bg-linear-to-r from-rose-200 via-pink-300 to-rose-200" />
        ...
        >
          <div className="mx-auto max-w-6xl px-4 py-3">
            <div className="relative rounded-2xl border border-stone-200 bg-white/90 shadow-md backdrop-blur-sm">
              <div className="pointer-events-none absolute inset-0 rounded-2xl bg-linear-to-r from-rose-50/90 via-pink-50/80 to-stone-50/90" />
...
function ActiveUnderline() {
  return (
    <span
      aria-hidden
      className="pointer-events-none absolute -bottom-1 left-1/2 h-1 w-6 -translate-x-1/2 rounded-full bg-linear-to-r from-pink-300 via-rose-300 to-pink-300"
    />
  );
}
