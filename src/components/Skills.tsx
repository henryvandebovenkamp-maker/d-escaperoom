...
export default function Skills() {
  const skills: Skill[] = [
    { icon: "🤝", title: "Teamwerk", text: "Elke puzzel vraagt om samenwerken: jij begeleidt, je hond onderzoekt als één team." },
    { icon: "💬", title: "Communicatie", text: "Je leert subtiele signalen lezen en op het juiste moment te belonen of sturen." },
    { icon: "🧠", title: "Vertrouwen & Focus", text: "Succeservaringen vergroten zelfvertrouwen en concentratie bij jullie allebei." },
    { icon: "🐾", title: "Initiatief", text: "Snuffelwerk en speuren geven je hond autonomie, jij biedt richting en veiligheid." },
    { icon: "🎯", title: "Probleemoplossend", text: "Samen ontdekken, nadenken en keuzes maken versterkt jullie samenwerking." },
    { icon: "🎉", title: "Plezier samen", text: "Positieve emoties koppelen jullie direct aan elkaar, de basis van een sterke band." },
  ];
  ...
  return (
    <section
      ...
      // Terug naar wit (sectie-achtergrond)
      className="relative bg-white py-16 sm:py-20"
    >
      {/* subtiele dotted textuur (mag blijven, is neutraal) */}
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        {/* BINNENKANT met zachte tint/gradient — behouden */}
        <div className="relative overflow-hidden rounded-3xl border border-stone-200 shadow-lg">
          ...
          <div className="relative backdrop-blur-sm">
            {/* TOPBAND: ruimte boven + gewenste grootte */}
            <div className="relative w-full overflow-hidden h-14 sm:h-16 lg:h-20">
              ...
              <h2 id="skills-title" className="sr-only">Vaardigheden</h2>
            </div>

            {/* header copy */}
            <div className="px-6 pt-6 text-center sm:px-10">
              <span className="mx-auto inline-block rounded-full border border-stone-200/80 bg-white/70 px-3 py-1 text-[11px] font-semibold tracking-wider text-stone-700">
                ...
                <li key={s.title} className="list-none">
                  ...
                  >
                    <article
                      ...
                      // Kaartjes: gloed altijd zichtbaar + hover lift
                      className="relative overflow-hidden rounded-2xl border border-stone-200/80 bg-white/80 p-4 shadow-sm transition duration-200 will-change-transform hover:-translate-y-1 hover:shadow-lg hover:border-pink-300/60 focus-visible:ring-2 focus-visible:ring-pink-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                    >
                      {/* gloed: ALTIJD ZICHTBAAR */}
                      <div
                        aria-hidden
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(to bottom, rgba(236,72,153,0.10), transparent 35%)",
                        }}
                      />
                      <div className="relative z-10 flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <span className="mt-3 inline-block h-[2px] w-12 rounded bg-stone-200 transition-colors duration-300 group-hover:bg-pink-400" />
                        </div>
                      </div>
                    </article>
                  </Link>
